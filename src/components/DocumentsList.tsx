  ...
  return (
    <div>
              ...
              {pinnedDocuments.map((doc) => (
                <li key={doc.id} className='py-4 flex items-center justify-between'>
                  <a
                    ...
                    className='text-[24px] font-gilroy font-light hover:underline hover:underline-offset-4'
                  >
                    {doc.name}
                  </a>
      ...
      {unpinnedDocuments.length > 0 && (
        <div ref={scrollableRef} className='px-15 py-4 max-h-[200px] overflow-y-auto documents-scrollable'>
          <ul>

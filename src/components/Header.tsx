        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center justify-center gap-0">
            ...
            {(() => {
              ...
              return (
                <button className="flex items-center gap-2 px-4 md:px-6 lg:px-7.5 py-4 md:py-6 lg:py-7.5 cursor-pointer border-x border-[#00000033] ">
                  <img src={contactIcon} alt="contact" className="h-7 md:h-8 lg:h-9 w-auto" />
                  <span 
                    className="hidden lg:inline font-gilroy text-[18px] lg:text-[19px] xl:text-[20px] font-light text-[#00000080]"
            ...
            <div className="relative self-stretch flex items-stretch">
              <button
                ...
                className="flex items-center gap-2 lg:gap-4 px-4 md:px-6 lg:px-7 py-4 md:py-6 lg:py-7.5 cursor-pointer border-r border-[#00000033] font-gilroy text-[18px] lg:text-[19px] xl:text-[20px] font-light h-full w-full"
              >
                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-0 bg-white border border-[#00000033] z-70 overflow-hidden shadow-lg">
                    <button
                      ...
                      className={`w-full text-center px-4 py-2 text-[18px] lg:text-[19px] xl:text-[20px] hover:bg-gray-100 transition font-gilroy font-light uppercase cursor-pointer ${
            ...
            {(() => {
              ...
              return (
                <button
                  onClick={onLogout}
                  className="pl-4 md:pl-8 lg:pl-12 xl:pl-[64.5px] py-4 md:py-6 lg:py-7.5 text-[#00000080] cursor-pointer font-gilroy text-[18px] lg:text-[19px] xl:text-[20px] font-light"
